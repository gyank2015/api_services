...
SECRET_KEY = '80(vs15kwd(9#8&1@1hyxex$+=mhza8uspc%-%mucqsox&(82y'
...
PROJ_MEDIA_ROOT = os.path.join(ENV_MEDIA_ROOT, 'car_damage')
MEDIA_ROOT = os.path.join(ENV_MEDIA_ROOT, 'car_damage')
MEDIA_URL = '/media/'
